...
public class Main {
		...
		public static void main(String[] args) {
			...
			System.out.println("Test1 – Suspect with most partners: " + topSuspect.getName() + ", " + topSuspect.getCode_name());
			...
			for(Suspect suspect: commonSuspects)
				System.out.println(suspect.getName() + ", " + suspect.getCode_name());
			
			//Test 6. print suspects originating from a country
			System.out.println("\nTest6 – Suspects coming from Spain: ");
			registry.getSuspectsFromCountry("Spain");
